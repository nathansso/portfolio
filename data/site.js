...
export const PROJECTS = [
  ...
  },
  {
    ...
    "description": "An Express.js development server that proxies the portfolio site and injects an overlay script into each page, enabling live WYSIWYG editing of the site's data layer (PROFILE, EXPERIENCES, PROJECTS). The overlay communicates with a REST API that reads and writes data/site.js in-place, so edits are reflected immediately on reload without touching any build tooling. Built as a productivity tool to streamline portfolio content updates without manually editing JavaScript.",
    "skills": [
      "javascript",
      "node.js",
      "express",
